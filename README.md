...
## Parte 2 Teorica
  ...
  R = El constructor sirve para inyección de dependencias o servicios, como lo dice su propio nombre, es lo primero que se ejecuta para poder crear o construir lo minimo necesario para nuestro componente y el ngOnInit es parte del ciclo 
  de vida del componente donde podemos inicializar la logica ya que cuando este se ejecuta ya se crearon los enlaces de datos del componente.
